...
@section('breadcrumbs')
    <ol class="breadcrumb">
        <li class="breadcrumb-item">Movimientos diarios</li>
        <li class="breadcrumb-item">Dar licencia</li>
    </ol>
@endsection
...
@section('content')
    <div class="vh-100 container-fluid">
        ...
        {!! Form::open(['route' => 'agent_licenses.index','class'=>'col-sm-12 search-agent']) !!}
        <div class="row">
        ...
        @include('agent_licenses.partials.agent')
