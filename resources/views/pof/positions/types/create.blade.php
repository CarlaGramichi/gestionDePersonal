...
@section('breadcrumbs')
    <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item"><a
                    href="{{ route('pof.positions.index', ['position'=>$position->id]) }}">Cargos</a>
        </li>
        <li class="breadcrumb-item">{{ $position->name }}</li>
        <li class="breadcrumb-item"><a href="{{ route("pof.positions.{position}.types.index",['position'=>$position->id]) }}">Subcargos</a></li>
